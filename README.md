...
> Lineage: 1 outbound / 0 inbound · ✅ No engine drift detected · Index coverage: todo · PII flags: 3 · Changelog: fresh (18 d)
...
| Pkg folder | [packages\vat-validations](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\vat-validations) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package vat-validations -Apply
