...
<div style='font-size:13px;opacity:0.92;'>Lineage heat: 1 outbound / 0 inbound · ✅ No engine drift detected · Index coverage: todo · PII: 3 · Changelog: fresh (18 d)</div>
</div>
...
- Pkg folder: [packages\vat-validations](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\vat-validations)
...
graph LR
  ...
  vat_validations["vat_validations"]:::center
  vat_validations -->|FK| countries["countries"]:::link
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package vat-validations -Apply
