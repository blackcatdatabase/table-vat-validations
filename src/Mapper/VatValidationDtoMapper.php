...
namespace BlackCat\Database\Packages\VatValidations\Mapper;
...
/**
 * Bidirectional mapper between DB rows and DTO VatValidationDto:
...
final class VatValidationDtoMapper
{
     ...
     * @return VatValidationDto
     */
    public static function fromRow(array $row): VatValidationDto
    {
        /** @var VatValidationDto */
        return DtoHydrator::fromRow(
            VatValidationDto::class,
            $row,
            self::COL_TO_PROP,
            self::BOOL_COLS,
            self::INT_COLS,
    ...
    public static function fromRowOrNull(?array $row): ?VatValidationDto
    {
     ...
     *
     * @param VatValidationDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(VatValidationDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(VatValidationDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(VatValidationDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,VatValidationDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,VatValidationDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(VatValidationDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,VatValidationDto>
     */
