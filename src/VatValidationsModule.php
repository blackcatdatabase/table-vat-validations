...
final class VatValidationsModule implements ModuleInterface
{
    public function name(): string { return 'table-vat_validations'; }
    public function table(): string { return 'vat_validations'; }
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedIdx = [];
        $expectedFk  = [ 'fk_vat_validations_country' ];
    ...
    public function info(): array
    {
        return [
            ...
            'indexes'     => [],
            'foreignKeys' => [ 'fk_vat_validations_country' ],
        ];
    }
}
