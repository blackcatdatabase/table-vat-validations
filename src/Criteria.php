 ...
 * - whitelist filtrů: [ 'id', 'vat_id', 'country_iso2', 'valid', 'checked_at', 'raw' ]
 * - whitelist pro LIKE hledání: [ 'vat_id', 'country_iso2' ]
 */
final class Criteria {
    ...
    public function toSql(bool $viewMode = false): array {
        ...
        // filtry (rovnosti / IN)
        $allowed = array_fill_keys([ 'id', 'vat_id', 'country_iso2', 'valid', 'checked_at', 'raw' ], true);
        ...
        if ($this->search !== null) {
            $searchCols = [ 'vat_id', 'country_iso2' ];
            $likeParts = [];
        ...
        $order = null;
        if ($this->sort) {
            $safeCols = array_fill_keys([ 'id', 'vat_id', 'country_iso2', 'valid', 'checked_at', 'raw' ], true);
            $parts = [];
