...
final class Criteria extends BaseCriteria
{
    ...
    {
        return [ 'id', 'vat_id', 'country_iso2', 'valid', 'checked_at', 'raw' ];
    }
    ...
    {
        $x = [ 'id', 'vat_id', 'country_iso2', 'valid', 'checked_at' ];
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\VatValidations\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\VatValidations\Definitions::softDeleteColumn();
