...
use BlackCat\Database\Packages\VatValidations\Repository\VatValidationRepositoryInterface;
use BlackCat\Database\Packages\VatValidations\Repository\VatValidationRepository as GeneratedRepository;
...
{
  private VatValidationRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof VatValidationRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected VatValidationRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\VatValidations\Dto\VatValidationDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\VatValidations\Dto\VatValidationDto|null { return $this->repo->getById($id, $asDto); }
