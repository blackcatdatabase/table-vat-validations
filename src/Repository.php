...
{
    private VatValidationRepository $repo;

    public function __construct(private Database $db)
    {
        $this->repo = new VatValidationRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\VatValidations\Dto\VatValidationDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\VatValidations\Dto\VatValidationDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\VatValidations\Dto\VatValidationDto|null
    {
